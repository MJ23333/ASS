...
function updateLayoutMeasurement(visualElement) {
  if (visualElement.shouldResetTransform())
    return;
  var layoutState2 = visualElement.getLayoutState();
  visualElement.notifyBeforeLayoutMeasure(layoutState2.layout);
  layoutState2.isHydrated = true;
  layoutState2.layout = visualElement.measureViewportBox();
  layoutState2.layoutCorrected = copyAxisBox(layoutState2.layout);
  visualElement.notifyLayoutMeasure(layoutState2.layout, visualElement.prevViewportBox || layoutState2.layout);
...
//# sourceMappingURL=chunk-CNDGGPYS.js.map
